...
void setup() {
  ...
  Left_Back_Thruster.attach(servoPin_LL);
  Right_Back_Thruster.attach(servoPin_RL); 

  //Set motor speed to zero
  Left_Side_Forward_Thruster.writeMicroseconds(stop_signal);
  Right_Side_Forward_Thruster.writeMicroseconds(stop_signal); 
  Left_Back_Thruster.writeMicroseconds(stop_signal);
  Right_Back_Thruster.writeMicroseconds(stop_signal); 
